...
if ( !class_exists( 'avia_sc_layout_row' ) )
{
	class avia_sc_layout_row extends aviaShortcodeTemplate{
...
*/
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$params['id'] = "av-layout-grid-".avia_sc_layout_row::$count;
