...
new WPUpdatesPluginUpdater_514( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if ( ! class_exists( 'WPUpdatesPluginUpdater_514' ) ) {
	class WPUpdatesPluginUpdater_514 {
