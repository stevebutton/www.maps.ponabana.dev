<div class="ap-tabs-board" id="board-about-settings" style="display: none;">
	...
	<div class="ap-tab-wrapper">
		<p><strong>AccessPress Anonymous Post Pro</strong> - is a the premium version plugin of  WordPress Plugin AccessPress Anonymous Post by AccessPress Themes. </p>
		...
		<p><strong>AccessPress Anonymous Post Pro</strong> - is a responsive HTML5 form to permit your website users (guests/visitors/not logged in users) to submit a standard WordPress Post in a simple and customized manner, with featured image and many other options. </p>
		...
		<p><strong>Please visit our product page for more details here:</strong><br />
			...
			<p><strong>Plugin documentation can be found here:</strong><br />
				<a href="http://accesspressthemes.com/wordpress-plugin-instruction-anonymous-post/" target="_blank">http://accesspressthemes.com/wordpress-plugin-instruction-anonymous-post-pro/</a></p>
				<div class="halfseperator"></div>
					...
					<p><strong>Feature comparison between free and premium plugin is here:</strong><br />
						...
						<div class="product">
						<div class="logo-product"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/aplite.png" alt="<?php esc_attr_e('AccessPress Anonymous Post','accesspresslite'); ?>" /></div>
						...
						<div class="product">
						<div class="logo-product"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/appro.png" alt="<?php esc_attr_e('AccessPress Anonymous Post','accesspresslite'); ?>" /></div>
						...
						<p><strong>Like us on facebook:</strong><br />
							...
							<ul class="social-icon">
								<li><a href="https://plus.google.com/106385805875992204629/" target="_blank"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/googleplus.png" alt="google+"></a></li>
								<li><a href="http://www.pinterest.com/accesspresswp/" target="_blank"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/pinterest.png" alt="pinterest"></a></li>
								<li><a href="https://www.flickr.com/photos/accesspressthemes/" target="_blank"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/flicker.png" alt="flicker"></a></li>
								<li><a href="https://twitter.com/apthemes" target="_blank"><img src="<?php echo AP_PRO_IMAGE_DIR;?>/twitter.png" alt="twitter"></a></li>
							</ul>
