...
<p>There are four main settings panels that will help you to setup the plugin and the frontend form properly.</p>
<dl>
  ...
  <dt><strong>Form Style Settings</strong></dt>
  <dd><p>In this tab you can customize all the settings regarding the form style options.You can either enable or disable the plugin style,or choose the style from already built in templates or use form styler to style yourself.</p></dd>
  ...
  <dd>
    <p>
      ...
      <input type="text" readonly="readonly" value='[ap-form id="form_id"]' onfocus="this.select();"/><br /><br />
       shortcode in  any page's content editor where you want to display the post submission form.Or if you want to use it in your template file then you can use <br /><br /><input type="text" readonly="readonly" value="&lt;?php echo do_shortcode('[ap-form id=&quot;form_id&quot;]');?&gt;" onfocus="this.select();" style="width: 370px;"/> where form_id is the respective form id</p>
