...
class Search_Filter {
	...
	public function enqueue_scripts() {
		...
		//{
			...
			//wp_localize_script($this->plugin_slug . '-plugin-script', 'SF_LDATA', array( 'ajax_url' => admin_url( 'admin-ajax.php' ), 'homeurl' => (home_url()), 'sfid' => $sf_form_data->get_active_form_id() ));
			//wp_localize_script($this->plugin_slug . '-plugin-ajax-script', 'SF_LDATA', array( 'ajax_url' => admin_url( 'admin-ajax.php' ), 'homeurl' => (home_url()), 'sfid' => $sf_form_data->get_active_form_id() ));
