(function ( $ ) {
	...
	$(function () {
		...
		function initSetupField()
		{
			...
			var $use_ajax_toggle_hidden = $('.setup .use_ajax_toggle_hidden');
			var $sf_ajax_container = $('.setup .sf_ajax');
			
			
			var $use_results_shortcode = $('.setup .use_results_shortcode');
			var $use_results_shortcode_hidden = $('.setup .use_results_shortcode_hidden');
			
			
			//grab the input type
			$use_template_manual_toggle.change(function(e)
			{
				handleSetupTemplateToggle($(this), $use_results_shortcode, $use_ajax_toggle);
			});
			
			handleSetupTemplateToggle($use_template_manual_toggle, $use_results_shortcode, $use_ajax_toggle);
			
			
			$use_ajax_toggle.change(function(e)
			{
				handleSetupAjaxToggle($(this), $use_results_shortcode, $use_results_shortcode_hidden, $use_template_manual_toggle);
			});
			
			handleSetupAjaxToggle($use_ajax_toggle, $use_results_shortcode, $use_results_shortcode_hidden, $use_template_manual_toggle);
			
			
			
			$use_results_shortcode.change(function(e)
			{
				handleResultsShortcodeToggle($(this), $use_template_manual_toggle);
			});
			
			handleResultsShortcodeToggle($use_results_shortcode, $use_template_manual_toggle);
		...
		function handleResultsShortcodeToggle($this, $use_template_manual_toggle)
		{
			...
			var $selectors_div = $('.setup .template-selectors');
			var $selectors_s_div = $('.setup .shortcode-selectors');
			...
			if(!$this.is(":checked"))
			{
				...
				$selectors_s_div.hide();
				$selectors_results_div.hide();
				//$selectors_div.slideDown("fast")
				
				$('.page-template-options').css("opacity", 1);
			...
			else
			{
				...
				$selectors_s_div.show();
				
				var $use_ajax_toggle = $('.setup .use_ajax_toggle');
				if($use_ajax_toggle.is(":checked"))
				{
				...
				//$('.page-template-options').css("opacity", 0.5);
				
			}
			
			setPageTemplateEnabled();
			
		}
		
		function handleSetupAjaxToggle($this, $use_results_shortcode, $use_results_shortcode_hidden, $use_template_manual_toggle)
		{
			...
			var $template_selectors_div = $('.setup .template-selectors');
			var $shortcode_selectors_div = $('.setup .shortcode-selectors');
			...
			if($this.is(":checked"))
			{
				...
				$use_results_shortcode.removeAttr("disabled");
				$use_results_shortcode_hidden.attr("disabled","disabled");
				...
				if($use_results_shortcode.is(":checked"))
				{
					$('.page-template-options').css("opacity", 0.5);
			...
			else
			{
				...
				$use_results_shortcode.attr("disabled","disabled");
				
				$use_results_shortcode_hidden.removeAttr("disabled");
				$use_results_shortcode_hidden.val($use_results_shortcode.val());
				
				$selectors_s_div.css("opacity", 0.5);
		...
		function setPageTemplateEnabled()
		{
			var $use_template_manual_toggle = $('.setup .use_template_manual_toggle');
			var $use_template_manual_toggle_hidden = $('.setup .use_template_manual_toggle_hidden');
			var $use_ajax_toggle = $('.setup .use_ajax_toggle');
			var $use_ajax_toggle_hidden = $('.setup .use_ajax_toggle_hidden');
			var $sf_ajax_container = $('.setup .sf_ajax');
			...
			var $template_div = $('.page-template-options.sub-option');
			
			//$use_template_manual_toggle.removeAttr("disabled");
			//$use_template_manual_toggle_hidden.attr("disabled","disabled");
			
			if((!$use_ajax_toggle.is(":checked")) || (($use_ajax_toggle.is(":checked"))&& (!$use_results_shortcode.is(":checked"))))
			{//then enable all page template stuff
				
				
				$use_template_manual_toggle.removeAttr("disabled");
				$use_template_manual_toggle_hidden.attr("disabled","disabled");
				
				if($use_template_manual_toggle.is(":checked"))
				{
			...
			{//disable page template stuff
				
				$use_template_manual_toggle.attr("disabled","disabled");
				$use_template_manual_toggle_hidden.removeAttr("disabled");
				$use_template_manual_toggle_hidden.val($use_template_manual_toggle.val());
		...
		function handleSetupTemplateToggle($this, $use_results_shortcode, $use_ajax_toggle)
		{
			var $template_name_manual = $('.setup .template_name_manual');
			var $template_name_manual_hidden = $('.setup .template_name_manual_hidden');
