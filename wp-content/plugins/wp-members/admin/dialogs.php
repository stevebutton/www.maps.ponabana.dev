...
/* 		if( $chkreq == "err" ) { ?>
	...
	if( $wpmem_settings[11] == 0 && $wpmem_settings[5] == 1 && $wpmem_dialogs[3] == 'Congratulations! Your registration was successful.<br /><br />You will recieve an email with login and password once the administrator has approved you.' ) { 
