	...
	*/
	...
	if( !get_option( 'wpmembers_settings' ) || $chk_force == true ) {
		...
		$wpmem_dialogs_arr = array(
			...
			"Congratulations! Your registration was submitted.<br /><br />When approved by the administrator, an e-mail with your login information will be sent to you.",
...
Your registration is waiting approval by the administrator.
When approved, you will recieve an e-mail with your login information.
';
...
function update_dialogs()
{
	...
	if( $wpmem_dialogs_arr[3] == "Congratulations! Your registration was successful.<br /><br />You will recieve an email with login and password once the administrator has approved you." ) {
		$wpmem_dialogs_arr[3] = "Congratulations! Your registration was successful.<br /><br />You will recieve an email with login and password once the administrator has approved you.";
		$do_update = true;
	}
