...
var ddajaxsidepanel = {
	defaults: {ajaxloadgif:'http://maps.ponabana.com/476.GIF', fx:{dur:'normal', easing:'swing'}, openamount:'80%', openamount_minthreshold:'400px'},
...
jQuery(function(){
	ddajaxsidepanel.init({
		...
		ajaxloadgif: 'http://maps.ponabana.com/476.GIF', //full path to "loading" gif relative to document. When in doubt use absolute URL to image.
